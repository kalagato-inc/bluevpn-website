         ...
         <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 py-12">
            ...
            >
                <div className="prose prose-invert prose-lg max-w-none 
                   ...
                   <h1 className="text-4xl md:text-5xl font-bold mb-8 text-center bg-clip-text text-transparent bg-gradient-to-r from-blue-400 to-white">Terms of Service & Privacy Policy</h1>
                   
                   <p className="text-sm text-slate-500 mb-8 text-center font-mono">Last Updated: January 1, 2024</p>

                   <h2>Terms of Service</h2>

                   <h3>Overview</h3>
                   <p>This website is operated by Human Data Systems Private Limited. Throughout the site, the terms "we", "us" and "our" refer to Human Data Systems Private Limited. Human Data Systems Private Limited offers this website, including all information, tools and services available from this site to you, the user, conditioned upon your acceptance of all terms, conditions, policies and notices stated here.</p>
                   ...
                   <p>Cancellation of our product after purchase is not allowed and might only be provided on our discretion for exceptional situations. In case of refunds for our products please read through our Refund Policy.</p>
                   ...
                   <p>Questions about the Terms of Service should be sent to us at bugs@bluevpn.com or contactus@kalagato.co.</p>

                   <hr className="my-12 border-white/10" />

                   <h2>Privacy Policy</h2>
                   <p>Human Data Systems Private Limited built the Blue VPN app as a Freemium app. This SERVICE is provided by Human Data Systems Private Limited at no cost and is intended for use as is.</p>
                   <p>This page is used to inform visitors regarding our policies with the collection, use, and disclosure of Personal Information if anyone decided to use our Service.</p>
                   <p>If you choose to use our Service, then you agree to the collection and use of information in relation to this policy. The Personal Information that we collect is used for providing and improving the Service. We will not use or share your information with anyone except as described in this Privacy Policy.</p>
                   <p>The terms used in this Privacy Policy have the same meanings as in our Terms and Conditions, which is accessible at Blue VPN unless otherwise defined in this Privacy Policy.</p>
                   ...
                   <h3>Contact Us</h3>
                   <p>If you have any questions or suggestions about our Privacy Policy, do not hesitate to contact us at bugs@bluevpn.com.</p>
                </div>
            </motion.div>
         </div>
    </div>
